...
const SERVER_NAME = 'fr-livestock-mcp';
...
const TOOLS = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        species: { type: 'string', description: 'Filter by species ID: dairy_cattle, beef_cattle, pigs, sheep, goats, horses, laying_hens, broilers. Also accepts aliases like "cattle" (returns both dairy + beef).' },
        jurisdiction: { type: 'string', description: 'ISO 3166-1 alpha-2 code (default: FR)' },
  ...
  },
  {
    ...
    description: 'Get welfare standards for a species. Returns both legal minimum requirements and best practice recommendations from Code rural et de la peche maritime.',
    inputSchema: {
      type: 'object' as const,
      properties: {
        species: { type: 'string', description: 'Species ID: dairy_cattle, beef_cattle, pigs, sheep, goats, horses, laying_hens, broilers. Also accepts aliases like "cattle".' },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        species: { type: 'string', description: 'Filter by species ID: dairy_cattle, beef_cattle, pigs, sheep, goats, horses, laying_hens, broilers. Also accepts aliases like "cattle".' },
        jurisdiction: { type: 'string', description: 'ISO 3166-1 alpha-2 code (default: FR)' },
      },
      required: ['query'],
    },
  ...
  },
  {
    ...
    description: 'Get livestock movement rules including identification, reporting, and disease restriction zones. Critical for biosecurity and disease control compliance.',
    inputSchema: {
      type: 'object' as const,
      properties: {
        species: { type: 'string', description: 'Species ID: dairy_cattle, beef_cattle, pigs, sheep, goats, horses, laying_hens, broilers. Also accepts aliases like "cattle".' },
