# France Livestock MCP

[![CI](https://github.com/ansvar-systems/fr-livestock-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/ansvar-systems/fr-livestock-mcp/actions/workflows/ci.yml)
[![GHCR](https://github.com/ansvar-systems/fr-livestock-mcp/actions/workflows/ghcr-build.yml/badge.svg)](https://github.com/ansvar-systems/fr-livestock-mcp/actions/workflows/ghcr-build.yml)
...
```json
{
  "mcpServers": {
    "uk-livestock": {
      "command": "npx",
      "args": ["-y", "@ansvar/fr-livestock-mcp"]
    }
  }
}
```
...
```bash
claude mcp add uk-livestock npx @ansvar/fr-livestock-mcp
```

### Streamable HTTP (remote)

```
https://mcp.ansvar.eu/fr-livestock/mcp
```

### Docker (self-hosted)

```bash
docker run -p 3000:3000 ghcr.io/ansvar-systems/fr-livestock-mcp:latest
```

### npm (stdio)

```bash
npx @ansvar/fr-livestock-mcp
```
